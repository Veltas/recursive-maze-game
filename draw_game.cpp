...
void DrawGame(HDC deviceContextHandle, Game &currentGame)
{
	...
	graphics.FillRectangle(
		...
		static_cast<INT>(currentMazeState.end[0] * (MAZE_GRID_CELL_SIZE + 1)),
		static_cast<INT>(currentMazeState.end[1] * (MAZE_GRID_CELL_SIZE + 1)));
